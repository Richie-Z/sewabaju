                                    ...
                                    ?>
                                        <tr align="center">
                                            ...
                                            <td align="center">
                                                <?php
                                                $now = date('Y-m-d');
                                                if ($row->status == "Selesai" || $row->status == "Hilang/Rusak") { ?>
                                                ...
                                                ?>
                                                    <a href="#myModal" data-toggle="modal" data-load-code="<?php echo $row->id_booking; ?>" data-remote-target="#myModal .modal-body"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;&nbsp;&nbsp;
                                                    <a href="<?php echo base_url("admin/pengembalian/selesai/" . $row->id_booking) ?>" class="btn btn-xs btn-primary" style="margin-bottom: 5px" onclick="return confirm('Apakah anda yakin akan menyelesaikan transkasi <?php echo $row->id_booking ?>?');">Selesai</a>
                                                    <a href="<?php echo base_url("admin/pengembalian/hilang/" . $row->id_booking) ?>" class="btn btn-xs btn-danger" style="margin-bottom: 5px" onclick="return confirm('Apakah anda yakin akan mengubah status <?php echo $row->id_booking ?> menjadi HILANG/RUSAK?');">Hilang/Rusak</a>
                                                <?php
                                                } ?>
                                            </td>
                                        </tr>
